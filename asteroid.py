...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        new_asteroid_1.velocity = pygame.Vector2(new_velocity_1.x * 1.2, new_velocity_1.y * 1.2)
        new_asteroid_2.velocity = pygame.Vector2(new_velocity_2.x * 1.2, new_velocity_2.y * 1.2)
